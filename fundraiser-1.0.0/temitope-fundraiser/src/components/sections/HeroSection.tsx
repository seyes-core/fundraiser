...
export function HeroSection({ stats, onDonate, onAbout }: HeroSectionProps) {
  return (
    <section
      style={{ maxWidth: 1060, margin: "0 auto", padding: "64px 20px 52px" }}
    >
      <div
        style={{
          display: "grid",
      ...
      >
        ...
        <div>
          ...
          >
            My name is{" "}
            <strong style={{ color: "#1A1917" }}>Temitope Ogungbuji</strong>. I
            am an aspiring software developer seeking internship opportunities
            while building skills in Python, SQL, and data engineering.
          </p>
          <p
            style={{
              fontSize: 17,
          ...
          >
            I am raising <strong style={{ color: "#1A1917" }}>₦350,000</strong>{" "}
            to purchase a Dell Latitude 7400 laptop — the tool I need to build
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 13, color: "#9C9A95", marginTop: 8 }}>
              Dell Latitude 7400
            </div>
          </div>
          ...
          >
            <div style={{ textAlign: "center", flex: 1 }}>
              ...
              >
                {formatNaira(stats.amount_raised)}
              </div>
            ...
            <div style={{ textAlign: "center", flex: 1 }}>
              ...
              >
                {calcPercent(stats.amount_raised, stats.goal_amount)}%
              </div>
              <div style={{ fontSize: 11, color: "#9C9A95", marginTop: 2 }}>
                of goal
              </div>
