...
export default function HomePage() {
  ...
  const shareLinks = [
    {
      label: "Share on X",
      url: `https://twitter.com/intent/tweet?text=Help+Temitope+Ogungbuji+get+his+first+dev+laptop+%E2%80%94+%E2%82%A6350%2C000+campaign.+Every+contribution+counts!&url=${encodeURIComponent(process.env.NEXT_PUBLIC_SITE_URL ?? "")}`,
    },
    {
      label: "Share on WhatsApp",
      url: `https://wa.me/?text=Help+Temitope+get+a+laptop+%26+build+a+tech+career:+${encodeURIComponent(process.env.NEXT_PUBLIC_SITE_URL ?? "")}`,
    },
    {
      label: "Share on LinkedIn",
      url: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(process.env.NEXT_PUBLIC_SITE_URL ?? "")}`,
    },
  ];
  ...
  return (
    <>
      ...
      <main>
        ...
        <section
          style={{ maxWidth: 1060, margin: "0 auto", padding: "0 20px 60px" }}
        >
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                  {["Python", "SQL", "ETL", "Analytics Engineering"].map(
                    (t) => (
                      <Tag key={t}>{t}</Tag>
                    ),
                  )}
        ...
        >
          ...
          >
            There are meaningful ways to support my journey that cost nothing
          ...
          >
            ...
            >
              Help me reach more people — every share increases the chance of
              reaching the goal.
            </div>
